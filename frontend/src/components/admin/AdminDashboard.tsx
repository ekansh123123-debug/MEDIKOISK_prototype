                ...
                <div 
                  ...
                  className={`p-3.5 rounded-2xl border transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs shadow-sm ${
                    isAck 
                      ...
                      : 'bg-white dark:bg-[#161d2b] border-rose-200 dark:border-rose-500/30'
                  }`}
                >
      ...
      <div className="glass-card rounded-2xl sm:rounded-3xl p-4 sm:p-6 border border-slate-200/80 dark:border-white/[0.07] shadow-xl space-y-4">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full sm:w-56 pl-8 pr-3 py-2 sm:py-1.5 rounded-xl text-xs bg-slate-50 dark:bg-[#131926] border border-slate-200 dark:border-white/[0.08] text-slate-800 dark:text-slate-200 focus-ring"
              />
            </div>

            {/* Filter Buttons */}
            <div className="flex items-center gap-1 bg-slate-100 dark:bg-[#111622] p-1 rounded-xl border border-slate-200 dark:border-white/[0.07] overflow-x-auto scrollbar-none">
              {(['ALL', 'EMERGENCY', 'FAST_TRACK', 'STANDARD'] as const).map(p => (
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg text-[11px] font-semibold transition-colors whitespace-nowrap shrink-0 cursor-pointer ${
                    filterPriority === p 
                      ? 'bg-white dark:bg-[#161d2b] text-teal-700 dark:text-teal-300 border border-transparent dark:border-white/[0.08] shadow-sm' 
        ...
        <div className="overflow-x-auto rounded-xl sm:rounded-2xl border border-slate-200 dark:border-white/[0.07]">
          <table className="w-full min-w-[650px] text-left text-xs" aria-label="OPD Outpatient Queue Table">
            <thead className="bg-slate-100 dark:bg-[#131926] text-slate-700 dark:text-slate-300 uppercase tracking-wider font-bold border-b border-slate-200 dark:border-white/[0.07]">
              <tr>
