...
export const HospitalQRScan: React.FC = () => {
  ...
  return (
    <div className="max-w-xl mx-auto py-2 sm:py-6 px-1 sm:px-2 animate-fade-in">
      <div className="glass-card-elevated rounded-2xl sm:rounded-3xl p-4 sm:p-8 border border-slate-200 dark:border-white/[0.07] dark:bg-[#111622] shadow-xl text-center space-y-5 sm:space-y-6">
        ...
        <div className="p-4 sm:p-6 bg-slate-100/70 dark:bg-[#131926] rounded-2xl border-2 border-dashed border-teal-500/30 inline-block relative group max-w-full">
        ...
        <div className="space-y-2 pt-1 text-left">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            <button
              ...
              className="p-2.5 rounded-xl border border-slate-200 dark:border-white/[0.07] bg-slate-50 dark:bg-[#161d2b] hover:border-teal-500 text-left transition-all tactile-btn cursor-pointer"
            >
        ...
        <div className="space-y-3 pt-1 max-w-sm mx-auto">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 text-xs font-mono font-bold text-center uppercase tracking-wider bg-slate-50 dark:bg-[#131926] border border-slate-300 dark:border-white/[0.07] rounded-xl text-slate-900 dark:text-slate-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
