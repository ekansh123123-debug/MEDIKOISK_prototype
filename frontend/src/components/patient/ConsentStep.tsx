  ...
  return (
    <div className="max-w-xl mx-auto py-2 sm:py-6 px-1 sm:px-2 animate-fade-in">
      <div className="glass-card-elevated rounded-2xl sm:rounded-3xl p-4 sm:p-8 border border-slate-200 dark:border-white/[0.07] dark:bg-[#111622] shadow-xl space-y-5 sm:space-y-6">
        ...
        <div className="p-3.5 bg-slate-50 dark:bg-[#161d2b] rounded-xl border border-slate-200 dark:border-white/[0.07] flex items-center justify-between">
        ...
        <div className="space-y-2.5 text-xs text-slate-700 dark:text-slate-300">
          <div className="p-3.5 bg-slate-50 dark:bg-[#161d2b] rounded-xl flex items-start gap-3 border border-slate-200 dark:border-white/[0.07]">
        ...
        <div className="pt-2 flex flex-col sm:flex-row gap-3">
          ...
          <button
            ...
            className="py-3.5 px-5 bg-slate-100 dark:bg-[#161d2b] hover:bg-slate-200 dark:hover:bg-[#1c1d22] text-slate-700 dark:text-slate-300 font-medium rounded-xl text-xs transition-colors flex items-center justify-center gap-1.5 border border-slate-200 dark:border-white/[0.07] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 cursor-pointer"
          >
