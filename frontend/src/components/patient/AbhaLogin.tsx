        ...
        {authMode === 'select' && (
          <div className="space-y-3.5 pt-2">
            <button
              ...
              className="w-full p-4 sm:p-5 bg-teal-50/60 dark:bg-[#161d2b] hover:bg-teal-100/50 dark:hover:bg-[#1c1d22] border-2 border-teal-500/30 dark:border-teal-500/40 rounded-xl flex items-center gap-4 text-left transition-all group shadow-sm tactile-btn focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 cursor-pointer"
            >
            ...
            <button
              ...
              className="w-full p-4 sm:p-5 bg-slate-50 dark:bg-[#161d2b] hover:bg-slate-100 dark:hover:bg-[#1c1d22] border border-slate-200 dark:border-white/[0.07] rounded-xl flex items-center gap-4 text-left transition-all group shadow-sm tactile-btn focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 cursor-pointer"
            >
              <div className="w-11 h-11 rounded-xl bg-slate-200 dark:bg-[#131926] text-slate-700 dark:text-slate-300 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform border border-slate-300 dark:border-white/[0.08]">
          ...
          <div className="space-y-4 pt-2">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 text-sm bg-slate-50 dark:bg-[#131926] border border-slate-300 dark:border-white/[0.07] rounded-xl text-slate-900 dark:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 font-mono"
              />
            </div>
              ...
              <div className="space-y-3 animate-fade-in">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 text-center tracking-widest text-lg font-mono font-bold bg-slate-50 dark:bg-[#131926] border border-slate-300 dark:border-white/[0.07] rounded-xl text-slate-900 dark:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
                  />
                </div>
          ...
          <div className="space-y-4 pt-2">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 text-sm bg-slate-50 dark:bg-[#131926] border border-slate-300 dark:border-white/[0.07] rounded-xl text-slate-900 dark:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
              />
            </div>
