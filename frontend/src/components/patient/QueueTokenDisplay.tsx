      ...
      <div className="glass-card-elevated rounded-2xl sm:rounded-3xl p-4 sm:p-8 border border-slate-200 dark:border-white/[0.07] dark:bg-[#111622] shadow-xl text-center space-y-5 sm:space-y-6">
        ...
        <div className={`p-6 rounded-2xl border-2 text-center relative overflow-hidden ${
          isEmergency
            ...
            : 'bg-slate-50 dark:bg-[#161d2b] border-teal-500/40 shadow-lg'
        }`}>
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="p-3 bg-slate-50 dark:bg-[#161d2b] rounded-xl border border-slate-200 dark:border-white/[0.07] shadow-sm">
        ...
        <div className="bg-slate-50 dark:bg-[#161d2b] rounded-xl p-4 border border-slate-200 dark:border-white/[0.07] text-left relative overflow-hidden">
        ...
        <div className="p-3 bg-slate-50/80 dark:bg-[#131926] rounded-xl border border-slate-200 dark:border-white/[0.07] flex items-center justify-between text-xs">
