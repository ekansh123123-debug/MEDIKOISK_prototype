...
export const ImpactMetrics: React.FC = () => {
  ...
  return (
    <section className="py-16 bg-white dark:bg-[#0c1017] border-t border-slate-200 dark:border-white/[0.07] relative overflow-hidden transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Patient Card */}
          <div className="p-6 sm:p-7 rounded-2xl bg-slate-50 dark:bg-[#111622] border border-slate-200 dark:border-white/[0.07] shadow-sm flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-3 text-xs">
                <div className="p-3.5 bg-white dark:bg-[#161d2b] rounded-xl border border-slate-200 dark:border-white/[0.06] shadow-sm">
            ...
            <div className="mt-6 pt-4 border-t border-slate-200 dark:border-white/[0.07] flex items-center justify-between text-xs font-bold text-teal-700 dark:text-teal-400">
          ...
          <div className="p-6 sm:p-7 rounded-2xl bg-slate-50 dark:bg-[#111622] border border-slate-200 dark:border-white/[0.07] shadow-sm flex flex-col justify-between">
            ...
            <div className="mt-6 pt-4 border-t border-slate-200 dark:border-white/[0.07] flex items-center justify-between text-xs font-bold text-cyan-700 dark:text-cyan-400">
          ...
          <div className="p-6 sm:p-7 rounded-2xl bg-slate-50 dark:bg-[#111622] border border-slate-200 dark:border-white/[0.07] shadow-sm flex flex-col justify-between">
            ...
            <div className="mt-6 pt-4 border-t border-slate-200 dark:border-white/[0.07] flex items-center justify-between text-xs font-bold text-indigo-700 dark:text-indigo-400">
