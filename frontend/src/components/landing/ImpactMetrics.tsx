...
export const ImpactMetrics: React.FC = () => {
  ...
  return (
    <section className="py-16 bg-white dark:bg-[#08090a] border-t border-slate-200 dark:border-white/[0.07] relative overflow-hidden transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Patient Card */}
          <div className="p-6 sm:p-7 rounded-2xl bg-slate-50 dark:bg-[#101114] border border-slate-200 dark:border-white/[0.07] shadow-sm flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-3 text-xs">
                <div className="p-3.5 bg-white dark:bg-[#16171b] rounded-xl border border-slate-200 dark:border-white/[0.06] shadow-sm">
