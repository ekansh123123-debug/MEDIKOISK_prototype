  ...
  return (
    <section className="py-24 bg-[#080d1a] border-t border-slate-800/80 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="bg-gradient-to-r from-teal-950/60 via-slate-900/80 to-slate-900/90 text-white rounded-3xl p-8 sm:p-12 border border-teal-500/30 backdrop-blur-xl shadow-2xl mb-16 relative overflow-hidden">
        ...
        <div className="mb-16 bg-slate-900/40 backdrop-blur-xl rounded-3xl p-6 sm:p-8 border border-slate-800/80 shadow-xl">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
            <div>
              <span className="text-xs font-bold text-teal-400 tracking-wider uppercase px-2.5 py-0.5 rounded-md bg-teal-950/60 border border-teal-500/20">
                National Health Authority Financial Model
              </span>
              <h3 className="text-xl font-bold text-white mt-2 font-['Outfit']">
                Self-Sustaining via Digital Health Incentive Scheme (DHIS)
              </h3>
            </div>
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-emerald-500/10 border border-emerald-500/30 text-emerald-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="p-5 bg-slate-950/60 rounded-2xl border border-teal-500/20">
              <span className="text-xs text-slate-400 font-medium">Base Eligibility</span>
              <div className="text-2xl font-black text-teal-400 mt-1">100 / mo</div>
              <p className="text-[11px] text-slate-400 mt-1">
                Qualifying digital ABHA transactions to unlock monthly incentives.
              </p>
            </div>

            <div className="p-5 bg-slate-950/60 rounded-2xl border border-cyan-500/20">
              <span className="text-xs text-slate-400 font-medium">OPD Intake & Rx (M2)</span>
              <div className="text-2xl font-black text-cyan-400 mt-1">₹5.00</div>
              <p className="text-[11px] text-slate-400 mt-1">
                Per digital outpatient consultation or prescription record created.
              </p>
            </div>

            <div className="p-5 bg-slate-950/60 rounded-2xl border border-indigo-500/20">
              <span className="text-xs text-slate-400 font-medium">Record Exchange (M3)</span>
              <div className="text-2xl font-black text-indigo-400 mt-1">₹10.00</div>
              <p className="text-[11px] text-slate-400 mt-1">
                Per consent-based longitudinal health record fetch & decryption.
              </p>
            </div>

            <div className="p-5 bg-slate-950/60 rounded-2xl border border-emerald-500/20">
              <span className="text-xs text-slate-400 font-medium">Software Vendor Tranche</span>
              <div className="text-2xl font-black text-emerald-400 mt-1">₹250+</div>
              <p className="text-[11px] text-slate-400 mt-1">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-900/40 backdrop-blur-xl rounded-3xl border border-slate-800/80 overflow-hidden shadow-xl">
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs">
                <thead className="bg-slate-950/80 text-slate-300 font-bold uppercase tracking-wider border-b border-slate-800">
                  <tr>
                ...
                <tbody className="divide-y divide-slate-800/60 font-normal">
                  {challenges.map((c, i) => (
                    <tr key={i} className="hover:bg-slate-850/40 transition-colors">
                      ...
                      <td className="px-6 py-4 text-slate-300 max-w-md leading-relaxed">
                        {c.mitigation}
                      </td>
                      <td className="px-6 py-4 text-right">
                        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-semibold bg-teal-500/10 border border-teal-500/30 text-teal-300">
