  ...
  return (
    <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8 animate-fade-in space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Card 1: Revocation */}
        <div className="p-6 bg-white dark:bg-slate-900/40 backdrop-blur-xl rounded-3xl border border-slate-200 dark:border-slate-800/80 shadow-sm dark:shadow-xl space-y-4 hover:border-rose-500/40 transition-all flex flex-col justify-between">
          <div>
            <div className="w-12 h-12 rounded-2xl bg-rose-500/10 border border-rose-500/20 text-rose-600 dark:text-rose-400 flex items-center justify-center font-bold mb-3">
          ...
          <button
            ...
            className="w-full py-2.5 bg-rose-50 dark:bg-rose-500/10 hover:bg-rose-100 dark:hover:bg-rose-500/20 text-rose-700 dark:text-rose-300 border border-rose-200 dark:border-rose-500/30 font-semibold rounded-xl text-xs transition-colors"
          >
            Revoke My Consent
          </button>
        </div>
        ...
        {/* Card 2: Export Data */}
        <div className="p-6 bg-white dark:bg-slate-900/40 backdrop-blur-xl rounded-3xl border border-slate-200 dark:border-slate-800/80 shadow-sm dark:shadow-xl space-y-4 hover:border-teal-500/40 transition-all flex flex-col justify-between">
          <div>
            <div className="w-12 h-12 rounded-2xl bg-teal-500/10 border border-teal-500/20 text-teal-600 dark:text-teal-400 flex items-center justify-center font-bold mb-3">
          ...
          <button
            ...
            className="w-full py-2.5 bg-teal-500 hover:bg-teal-600 text-slate-950 font-bold rounded-xl text-xs transition-colors shadow-lg shadow-teal-500/20 flex items-center justify-center gap-2"
          >
        ...
        <div className="p-6 bg-white dark:bg-slate-900/40 backdrop-blur-xl rounded-3xl border border-slate-200 dark:border-slate-800/80 shadow-sm dark:shadow-xl space-y-4 hover:border-slate-400 dark:hover:border-slate-700 transition-all flex flex-col justify-between">
          <div>
            <div className="w-12 h-12 rounded-2xl bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-700 flex items-center justify-center font-bold mb-3">
          ...
          <button
            ...
            className="w-full py-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800/80 dark:hover:bg-slate-750 text-slate-700 dark:text-slate-200 border border-slate-300 dark:border-slate-700 font-semibold rounded-xl text-xs transition-colors"
          >
      ...
      <div className="p-8 bg-gradient-to-r from-teal-50/80 via-sky-50/50 to-slate-100/90 dark:from-slate-900/80 dark:via-teal-950/40 dark:to-slate-900/90 backdrop-blur-xl rounded-3xl border border-teal-500/20 dark:border-teal-500/30 space-y-5 shadow-sm dark:shadow-2xl">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            <h3 className="text-lg font-bold text-slate-900 dark:text-white flex items-center gap-2.5 font-['Outfit']">
          ...
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-teal-500/10 border border-teal-500/30 text-teal-700 dark:text-teal-300">
            End-to-End Encrypted
          </span>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
          <div className="p-4 bg-white dark:bg-slate-950/60 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
            <span className="text-teal-700 dark:text-teal-400 font-bold block mb-1 text-[11px] uppercase tracking-wider">Key Agreement Protocol</span>
          ...
          <div className="p-4 bg-white dark:bg-slate-950/60 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
            <span className="text-teal-700 dark:text-teal-400 font-bold block mb-1 text-[11px] uppercase tracking-wider">Symmetric Cipher Suite</span>
          ...
          <div className="p-4 bg-white dark:bg-slate-950/60 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
            <span className="text-teal-700 dark:text-teal-400 font-bold block mb-1 text-[11px] uppercase tracking-wider">Integrity Checksum</span>
      ...
      <div className="bg-white dark:bg-slate-900/40 backdrop-blur-xl rounded-3xl p-6 sm:p-8 border border-slate-200 dark:border-slate-800/80 shadow-sm dark:shadow-xl space-y-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-slate-500 dark:text-slate-400">Cryptographically verifiable event stream</span>
        </div>
