    ...
    <div className="max-w-xl mx-auto py-4 px-2 animate-fade-in">
      <div className="glass-card-elevated rounded-3xl p-6 sm:p-8 border border-teal-500/20 shadow-2xl space-y-6">
        ...
        <div className="flex items-center justify-between pb-3 border-b border-slate-800 text-xs">
          <span className="font-bold text-teal-400">Step: Identity Verification</span>
          <span className="text-slate-400">ABDM Registry Connector</span>
        </div>
        ...
        <div className="text-center space-y-1">
          ...
          <p className="text-xs text-slate-400">
            Connect your Ayushman Bharat Health Account (ABHA) or register with your mobile number.
          </p>
        </div>
        ...
        {authMode === 'select' && (
          <div className="space-y-4 pt-2">
            <button
              ...
              className="w-full p-5 bg-gradient-to-r from-teal-500/10 via-cyan-500/10 to-sky-500/10 hover:from-teal-500/20 hover:to-cyan-500/20 border-2 border-teal-500/40 rounded-2xl flex items-center gap-4 text-left transition-all group backdrop-blur-md"
            >
            ...
            <button
              ...
              className="w-full p-5 bg-slate-900/60 hover:bg-slate-800/80 border border-slate-800 rounded-2xl flex items-center gap-4 text-left transition-all group backdrop-blur-md"
            >
              <div className="w-12 h-12 rounded-xl bg-slate-800 text-slate-300 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform border border-slate-700">
        ...
        {authMode === 'abha' && (
          <div className="space-y-4 pt-2">
            <div className="p-3 bg-teal-500/10 rounded-xl border border-teal-500/20 text-xs text-teal-300 flex items-center gap-2">
              <CheckCircle2 className="w-4 h-4 shrink-0 text-teal-400" />
              <span>NHA ABDM Gateway Gateway Connected</span>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 text-sm bg-slate-900/80 border border-slate-700 rounded-xl text-white focus:ring-2 focus:ring-teal-500 focus:outline-none"
              />
            </div>
              ...
              <div className="space-y-3 animate-fade-in">
                <div>
                  ...
                  <input
                    ...
                    placeholder="123456"
                    className="w-full px-4 py-3 text-center tracking-widest text-lg font-mono font-bold bg-slate-900 border border-slate-700 rounded-xl text-white focus:ring-2 focus:ring-teal-500 focus:outline-none"
                  />
                </div>
          ...
          <div className="space-y-4 pt-2">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 text-sm bg-slate-900 border border-slate-700 rounded-xl text-white focus:ring-2 focus:ring-teal-500 focus:outline-none"
              />
            </div>
            ...
            >
              <span>Continue with Temporary Walk-in ID</span>
