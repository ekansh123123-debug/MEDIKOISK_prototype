  ...
  return (
    <div className="max-w-xl mx-auto py-6 px-2 animate-fade-in">
      <div className="glass-card-elevated rounded-2xl p-6 sm:p-8 border border-slate-200 dark:border-slate-800 shadow-xl text-center space-y-6">
        ...
        <div className="p-6 bg-slate-100/70 dark:bg-slate-950/60 rounded-2xl border-2 border-dashed border-teal-500/30 inline-block relative group">
          <div className="w-52 h-52 mx-auto bg-white rounded-xl p-4 shadow-md flex flex-col items-center justify-center relative overflow-hidden">
            <QrCode className="w-44 h-44 text-slate-900" aria-hidden="true" />
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="w-11 h-11 bg-teal-600 rounded-xl flex items-center justify-center text-white shadow-md border-2 border-white">
                <Building2 className="w-5 h-5" aria-hidden="true" />
              </div>
            </div>
          </div>
