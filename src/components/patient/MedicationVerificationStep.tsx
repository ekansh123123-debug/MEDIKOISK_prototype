    ...
    <div className="max-w-2xl mx-auto py-4 px-2 animate-fade-in">
      <div className="glass-card-elevated rounded-3xl p-6 sm:p-8 border border-teal-500/20 shadow-2xl space-y-6">
        ...
        <div className="flex items-center justify-between pb-3 border-b border-slate-800 text-xs">
          <span className="font-bold text-teal-400">Step: Extracted Medication Verification</span>
          <span className="text-slate-400">Human-In-The-Loop Safety Protocol</span>
        </div>
        ...
        <div className="text-center space-y-1">
          ...
          <p className="text-xs text-slate-400 max-w-md mx-auto">
            AI extracted these prescriptions from your document. Please verify, edit, or reject each item before it is committed to your medical record.
          </p>
        </div>

        {/* Clinical Safety Banner */}
        <div className="p-3.5 bg-amber-500/10 border border-amber-500/30 rounded-2xl flex items-start gap-2.5 text-xs text-amber-200 backdrop-blur-md">
          <AlertTriangle className="w-5 h-5 text-amber-400 shrink-0 mt-0.5" />
          <div>
            <strong className="text-white">Safety Verification Protocol:</strong>
                ...
                {isEditing ? (
                  <div className="space-y-3">
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs">
                      <div>
                        <label className="font-bold text-slate-300">Medicine Name</label>
                        <input
                          type="text"
                          value={editForm.name}
                      ...
                      <div>
                        <label className="font-bold text-slate-300">Strength</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="font-bold text-slate-300">Frequency</label>
                        <input
                          type="text"
                    ...
                    <div className="flex gap-2 justify-end">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 bg-gradient-to-r from-teal-500 to-cyan-500 text-slate-950 font-bold rounded-lg text-xs"
                      >
                        Save & Confirm
                      </button>
                    </div>
