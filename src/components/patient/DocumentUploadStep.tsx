  ...
  return (
    <div className="max-w-xl mx-auto py-2 sm:py-6 px-1 sm:px-2 animate-fade-in">
      <div className="glass-card-elevated rounded-2xl sm:rounded-3xl p-4 sm:p-8 border border-slate-200 dark:border-slate-800 shadow-xl space-y-5 sm:space-y-6">
        ...
        {isProcessing ? (
          <div className="p-8 bg-slate-50 dark:bg-slate-900/80 rounded-2xl border border-teal-500/40 text-center space-y-4 animate-fade-in">
              ...
              {[
                ...
                return (
                  <div key={idx} className="flex flex-col items-center gap-1">
                    <div className={`w-full h-1.5 rounded-full ${isPassed ? 'bg-teal-600' : 'bg-slate-200 dark:bg-slate-800'}`} />
